<p align="center">
    <img src="https://cdn.discordapp.com/attachments/1020807099439140914/1061217920400756756/coders-daybook-rose.png" width="200" height="200" />
</p>
...
php artisan db:seed
```
You must include cloudinary `.env` variables since we utilise [cloudinary](https://cloudinary.com) to store our photos and videos. 
```.env
CLOUDINARY_URL=
