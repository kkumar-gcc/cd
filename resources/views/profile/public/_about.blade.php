<div
    ...
    <div
        class="py-3 px-4 rounded-lg relative prose max-w-none prose-a:no-underline lg:max-w-full xl:max-w-none  dark:prose-invert prose-a:text-skin-600 dark:prose-a:text-skin-500">
        @if ($user->about_me)
