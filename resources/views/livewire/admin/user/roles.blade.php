<div>
    ...
    <div x-data="{ modal: @entangle('assignRole') }" class="flex justify-center">
                ...
                <div x-on:click.stop="" x-trap.noscroll.inert="modal"
                    ...
                    <header class="flex items-center ">
                        ...
                        <div class="flex-1 flex justify-end">
                            <x-buttons.primary @click="modal=false" class="hover:text-bg-skin-base-600">
                        ...
                        <div class="flex flex-col md:flex-row">
                            <div class="flex-1">
                                @if ($user->roles->count() > 0)
                                    <h5 class="mb-4 font-semibold text-xl">Role List</h5>
                                        ...
                                        <div class="mb-3 p-4 flex flex-row border rounded-lg shadow-sm hover:shadow-md">
                                            ...
                                            @if (auth()->user()->can('assign roles'))
                                                <button type="button" class="mx-3 pl-2 "
                                                    wire:click="removeRole('{{ $user_role->id }}','{{ $user->id }}')">
                            ...
                            @if (count($roles) > 0 &&
                               ...
                               <div class="md:ml-12  flex-1">
                                    <h5 class="mb-4 font-semibold text-xl">Assign Roles</h5>
